...
BASELINE_DIR = Path("outputs/eval/baseline_qwen25_15b_gsm8k_cot_limit100")
SFT_V5_DIR = Path("outputs/eval/sft_lora_v5_eval_style_completion_only_qwen25_15b_gsm8k_cot_limit100")

OUTPUT_DIR = Path("outputs/reports")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_PATH = OUTPUT_DIR / "baseline_vs_sft_v5_sample_comparison.json"
