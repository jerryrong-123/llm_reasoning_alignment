...
def main():
    ...
    parser.add_argument("--output", default="data/processed/grpo_v4_hard_prompts_from_sft_v5.jsonl")
    parser.add_argument("--preview", default="data/samples/grpo_v4_hard_prompts_from_sft_v5_preview.jsonl")
    parser.add_argument("--max_source_samples", type=int, default=1200)
    parser.add_argument("--target_records", type=int, default=500)
    ...
    def flush_batch():
        ...
        for meta, response in zip(metas, texts):
            ...
            records.append(
                {
                    "prompt": meta["prompt"],
                    "answer": gold,
                    "source": "gsm8k_train_sft_v5_wrong",
                    "question": meta["question"],
                    "sft_v5_pred_answer": pred,
    ...
    print("====== 生成 SFT_v5 hard prompts ======")
    n = min(args.max_source_samples, len(ds))

    for row in tqdm(ds.select(range(n))):
    ...
    print("====== GRPO_v4 hard-prompt 数据完成 ======")
