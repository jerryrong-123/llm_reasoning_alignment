...
def main():
    ...
    parser.add_argument("--max_percentage", type=int, default=80)
    parser.add_argument("--max_money_profit", type=int, default=80)
    parser.add_argument("--max_unit_rate", type=int, default=40)
    parser.add_argument("--max_general", type=int, default=50)
    ...
    parser.add_argument(
        "--preview_file",
        type=str,
        default="data/samples/sft_small_v2_preview.jsonl",
    )
    ...
    print("====== 构造 targeted SFT small_v2 数据 ======")
    ...
    if not rows:
        raise ValueError("没有构造出有效的 sft_small_v2 样本，请检查数据集字段。")
    ...
    print("====== SFT small_v2 targeted 数据构造完成 ======")
