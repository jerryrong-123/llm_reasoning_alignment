...
SAMPLE_PATH = list(
    Path("outputs/eval/sft_lora_v5_eval_style_completion_only_qwen25_15b_gsm8k_cot_limit200").glob("**/*.jsonl")
)[0]

OUTPUT_DIR = Path("outputs/reports")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_PATH = OUTPUT_DIR / "sft_v5_limit200_normalized_answer_analysis_grouped.json"
