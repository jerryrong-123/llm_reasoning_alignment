...
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "checkpoints" / "qwen25_7b_rag_sft_lora_full"
REPORT_PATH = PROJECT_ROOT / "outputs" / "hierarchical_rag" / "reports" / "qwen25_7b_rag_sft_lora_full_report.md"
...
def main():
    print("====== Qwen2.5-7B RAG-SFT LoRA Full Training ======", flush=True)
    ...
    report_lines = []
    report_lines.append("# Qwen2.5-7B RAG-SFT LoRA Full Report")
    report_lines.append("")
    report_lines.append("## 1. Purpose")
    report_lines.append("")
    report_lines.append("This full run fine-tunes Qwen2.5-7B with 4bit QLoRA on the RAG-SFT data.")
    report_lines.append("")
