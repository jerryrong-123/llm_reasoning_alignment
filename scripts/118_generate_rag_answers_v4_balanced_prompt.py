...
OUTPUT_FILES = {
    "top10_original_recheck": GENERATION_DIR / "rag_answers_v4_top10_original_recheck_qwen05b.jsonl",
    "top10_soft_cap2_compressed": GENERATION_DIR / "rag_answers_v4_top10_soft_cap2_compressed_qwen05b.jsonl",
    "top7_soft_cap2_compressed": GENERATION_DIR / "rag_answers_v4_top7_soft_cap2_compressed_qwen05b.jsonl",
}

METRICS_PATH = EVAL_DIR / "rag_answer_generation_v4_balanced_prompt_metrics.json"
REPORT_PATH = REPORT_DIR / "rag_answer_generation_v4_balanced_prompt_report.md"
...
def main():
    print("====== RAG Answer Generation v4 Balanced Prompt ======", flush=True)
    ...
    all_metrics = {
        "method": "rag_answer_generation_v4_balanced_prompt",
    ...
    print("====== v4 生成完成 ======", flush=True)
    print("metrics:", METRICS_PATH, flush=True)
    print("report:", REPORT_PATH, flush=True)

    print("====== v4 生成指标汇总 ======", flush=True)
    for name, metrics in all_metrics["variants"].items():
        print(
            f"{name}: "
